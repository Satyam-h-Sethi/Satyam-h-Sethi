...
<table>
  <tr>
    <td width="50%" valign="top">
      <div><strong><code>FINTECH</code></strong></div>
      <h4><a href="https://recon.satyamsethi.dpdns.org">transaction-reconciliation-engine</a></h4>
      <p>Multi-way ledger reconciliation matching internal transactions against bank statements with automated break resolution.</p>
    ...
    <td width="50%" valign="top">
      ...
      <p>Rule-based compliance validator enforcing ISO 6166 ISIN checksums, ISO 4217 currencies, LEIs, and trade integrity rules.</p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Multi-rail clearing operations monitor (Fedwire, SWIFT, SEPA, ACH, RTGS) tracking settlement cycles, latency, and exceptions.</p>
    ...
    <td width="50%" valign="top">
      <div><strong><code>ENGINEERING</code></strong></div>
      <h4><a href="https://cache.satyamsethi.dpdns.org">http-cache-proxy</a></h4>
      <p>In-memory caching reverse proxy with TTL eviction, <code>X-Cache</code> telemetry headers, and real-time traffic analytics.</p>
  ...
  <tr>
    <td width="50%" valign="top">
      <div><strong><code>INFRASTRUCTURE</code></strong></div>
    ...
    <td width="50%" valign="top">
      <div><strong><code>DEVOPS & EDUCATION</code></strong></div>
      <h4><a href="https://linux.satyamsethi.dpdns.org">linux-interview-notes-web</a></h4>
      <p>Interactive Linux &amp; DevOps revision command center with hierarchical notes, oral Q&amp;A drills, flashcards, and incident playbooks.</p>
